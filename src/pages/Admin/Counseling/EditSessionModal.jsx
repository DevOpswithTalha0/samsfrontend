...
const EditSessionModal = ({
  ...
  const handleStatusUpdate = () => {
    if (selectedStatus !== session.status) {
      onUpdateStatus(session._id, selectedStatus);
    }
  };
            ...
            <div className="space-y-3 sm:space-y-4">
              ...
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center space-y-2 sm:space-y-0 sm:space-x-4">
                <button
                  ...
                  disabled={isLoading || selectedStatus === session.status}
                  className="px-3 sm:px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center text-xs sm:text-sm"
                >
                  {isLoading ? (
                    <>
